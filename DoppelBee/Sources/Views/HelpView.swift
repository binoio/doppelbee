    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                DoppelBee is a native macOS authenticator that generates one-time passwords (OTP) for two-factor authentication.
                ...
                • Verify the file is a valid DoppelBee database
                """)
